...
export const FootGL = () => {
  return (
    <div className="md:absolute fixed bottom-0 flex h-[56vh] flex-1 w-full z-0 flex-col items-start justify-start mask-alpha mask-t-from-0% mask-t-to-69% overflow-clip">
