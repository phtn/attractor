  ...
  const MOCK_USERS = [
    {
      id: "alice",
      name: "Alice",
      publicKey: "RXZRKn5qj0klMpr6HXAw2G1obH2NWxN+vIGYhDDTW0U=",
      privateKey: "QtNxTCjn9d/m+zHAOS+0khVxf7tyUCVFpvdGsIg7JNY=",
    },
    {
      id: "bob",
      name: "Bob",
      publicKey: "VDxY6AmpB1kWVhVLbcbz6umfIFZHcuYA4u5dfzZ8WxU=",
      privateKey: "o0UjKydZLiniAaiWYg5e2wudFm80SGWWp/6fBEYIkM4=",
    },
    {
      id: "charlie",
      name: "Charlie",
