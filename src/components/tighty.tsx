  ...
  return (
    <button
      ...
      className={cn(
        ...
        "shadow-[0px_0px_0px_1px_theme(colors.black/4%),0_1px_1px_theme(colors.black/5%),0_1px_1px_theme(colors.black/5%),0_1px_1px_theme(colors.black/5%)]",
        ...
        "rounded-sm border-[0.5px] border-xy/80 dark:border-teal-50/60",
        "[&_svg]:pointer-events-none [&_svg]:shrink-0 px-1.5",
        "md:h-8 h-6 md:px-4 md:rounded-md",
    ...
    >
      ...
      <span className="text-xs md:text-sm md:font-medium tracking-tight">
        {label}
      </span>
    </button>
  );
