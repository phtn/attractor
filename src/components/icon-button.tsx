  ...
  return (
    <button
      ...
      className={cn(
        ...
        "dark:inset-shadow-[0_0.5px_theme(colors.white/15%)] dark:hover:bg-card-origin/40 dark:bg-card-origin/10",
        ...
        "rounded-md border-[0.5px] border-xy/80 dark:border-teal-50/20",
