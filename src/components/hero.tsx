export const Hero = () => {
  return (
    <div className="px-4 pt-4 ">
      <div className="dark:bg-card-origin/40 bg-card text-card-foreground flex flex-col rounded-xl py-5 shadow-sm dark:inset-shadow-[0_1px_rgb(255_255_255/0.15)] gap-4"></div>
    </div>
  );
};
